...
$user	ALL=NOPASSWD:/usr/local/sbin/mount-crypt.sh,/usr/local/sbin/umount-crypt.sh,/sbin/reboot,/sbin/shutdown,/bin/passwd,/usr/sbin/pm-suspend,/etc/init.d/cryptnmount
EOF
